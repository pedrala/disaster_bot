...
class FireEx(Node):
    ...
    def image_callback(self, msg):
        ...
        frame_with_keypoints = cv2.drawKeypoints(frame, keypoints_frame, None, color=(0, 255, 0), flags=cv2.DrawMatchesFlags_DEFAULT)
        ...
        for ref in self.reference_data:
            ...
            if len(matches) > 10:
                ...
                if self.match_count % 30 == 0:  # 매 30프레임마다 저장 및 표시
                    ...
                    # 참조 이미지와 프레임을 그레이스케일로 변환하여 매칭 시각화
                    ref_image_gray = cv2.cvtColor(ref_image_color, cv2.COLOR_BGR2GRAY)
